...
public class PronosticosDeportivos {
    ...
    public static void main(String[] args) {
        ...
        pro1.leerPronostico();//ingreso la info del pronostico(hay que sacarla del archivo)
        Pronostico pro2= new Pronostico();//creo otro objeto pronostico
        pro2.leerPronostico();//ingreso la info del pronostico(hay que sacarla del archivo)
        r1.recorrerVector(pro1, 0);// recorro el vector hasta la posicion que le mando y me fijo si los resultados son iguales
        r1.recorrerVector(pro2, 1);//lo mismo pero en la posicion siguiente
        
    }
    //creo que la ruta a los archivos tendriamos que pasarlas en las clase ronda y en la clase pronostico  
}
